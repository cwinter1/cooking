...
A comprehensive meal prep guide for low-GI, high-protein meals using a modular base + protein system.
...
### Combo D: White Beans & Sweet Potato Base
...
- **`Meal_Prep_White_Beans_Sweet_Potato.pdf`** – Full printable guide with shopping list, prep instructions, and morning routine
- **`README.md`** – This file
- **`RECIPES.md`** – Detailed recipe cards (individual)
- **`SHOPPING_LIST.md`** – Consolidated shopping list
- **`HEBREW_README.md`** – Hebrew language version
...
| Sweet potato | 1.2 kg | Medium-sized |
| Garlic | 1 bulb | 4-5 cloves |
| Onion | 1 large | Yellow preferred |
...
## 👨‍🍳 Preparation (Friday - 90 minutes)

### Step 1: Prepare Vegetables (30 min)
1. Peel and cube sweet potato into 1.5cm cubes
2. Dice onion finely
3. Mince garlic (4-5 cloves)

### Step 2: Cook Base (40 min)
1. Heat 2 tbsp olive oil in large pot over medium heat
2. Add diced onion + minced garlic, sauté 3-4 min
3. Add 1 kg frozen white beans (no thaw needed)
4. Add cubed sweet potato
5. Add 300 ml water
6. Season: 1 tsp sea salt + ½ tsp black pepper
7. Bring to boil → reduce to low-medium heat
8. Simmer 35-40 min until sweet potato is soft
9. Stir occasionally to prevent sticking

### Step 3: Cool & Portion (20 min)
1. Spread on large flat tray to cool to room temperature
2. Divide into 10-12 portions of 200g each (use scale)
...
### Salmon
- **Portion:** 85-90g per freezer bag
- **Cooking:** Thaw 5 min in warm water → pan-fry 10-12 min with 1 tsp oil on medium-high
- **Doneness:** Flakes easily with fork, no translucent center

### White Fish (Tilapia, Sea Bass)
- **Portion:** 85-90g per freezer bag
- **Cooking:** Thaw 5 min in warm water → pan-fry 8-10 min with 1 tsp oil on medium heat
- **Doneness:** Flesh opaque throughout, flakes with gentle pressure

### Chicken Breast
- **Portion:** 90-100g per freezer bag (shrinks more than fish)
...
### Pro Tips
- Always cool base fully before freezing (prevents ice crystals)
...
### Low-GI Ingredients Used
| Ingredient | GI | Portion |
|-----------|-----|---------|
| White beans | 24 | 150g |
...
✅ Perfect for:
- Office lunch at work (15-20 min morning cook)
- Low-GI diet management
- High-protein meal prep
- Flexible protein rotation
- Batch cooking (10-12 portions at once)
...
Created for low-GI, high-protein meal prep system. All portions calculated for:
- Daily work lunch (Monday-Friday)
- Intermittent fasting window (11:00–22:00)
- High-protein intake (35-40g per meal)
- Fast morning preparation (<20 minutes)

---

## 📄 Documents

- See **`Meal_Prep_White_Beans_Sweet_Potato.pdf`** for full printable guide
- See **`RECIPES.md`** for detailed recipe cards
- See **`HEBREW_README.md`** for Hebrew language version
